...
if __name__ == '__main__':
    ...
    username = 'yuyaoyang247@sina.com'
    pwd = '13653654086yao'
	...
	kaifu_page = urllib2.urlopen('http://weibo.com/1558446957/myfans?from=page_100505&wvr=5.1&mod=headfans').read()
	print kaifu_page

    else:
        print 'Login WEIBO failed'

# url = "http://weibo.com/1558446957/myfans"
# login(username, pwd, cookie_file)
